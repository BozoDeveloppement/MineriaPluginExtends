...
import fr.parsival.mineriapluginextends.commands.*;
...
public class Commands<T extends Team, U extends IridiumUser<T>> {
    ...
    public Commands(String permissionBase, String team, String commandBase) {
        ...
        bypassCommand = new BypassCommand<>(Collections.singletonList("admin bypass"), "Bypass " + team + " restrictions", "%prefix% &7/" + commandBase + " bypass", permissionBase + ".bypass", 0);
